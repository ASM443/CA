...
function recordData() {
    ...
    document.getElementById("submitForm").classList.toggle("hide");
    document.getElementById("demo").innerHTML = "Thank you for reporting the Invasive Species."
...
function stopRecording() {
    ...
    document.getElementById("submitForm").classList.remove("hide");
    findMaxMin();
}
...
async function mainEvent() {
    if (/Android|iPhone/i.test(navigator.userAgent)) {
        ...
        document.getElementById("recbtn").classList.toggle("hide");
        document.getElementById("demo").innerHTML = "Please ensure you are on a mobile device and have location serveres enabled"
        //Add not running on mobile message
    }

    
    navigator.geolocation.getCurrentPosition(updateCenter, locationError);
